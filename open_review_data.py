...
def save_paper(pdf_url, filename, get_review=False):
    ...
    if response.status_code == 200:
        ...
        if get_review:
            # TO DO
            # Implement the logic to get the review for the paper
            # Probably save filename and review into a csv?
            pass
...
def main():
    ...
    try:
        ...
        note = client.get_note('CTJ5ERXOYE')
        use_api2 = True
